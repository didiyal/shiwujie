...
public class VolunteerController {
    ...
    @Operation(summary = "手机号一键登录/注册志愿者")
    ...
    @Operation(summary = "手机号密码登录/注册志愿者")
