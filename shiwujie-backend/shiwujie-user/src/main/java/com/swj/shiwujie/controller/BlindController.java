...
public class BlindController {
    ...
    @Operation(summary = "手机号一键登录/注册视障用户")
    ...
    @Operation(summary = "手机号密码登录/注册视障用户")
    ...
    @Operation(summary = "根据ID获取视障人士信息")
