...
//                // 返回应答消息
//                String responseStr = "用户" + remoteId +
//                        "加入连接 ===>>> " + remoteId + requestStr;
//                TextWebSocketFrame tws = new TextWebSocketFrame(responseStr);
...
//        });
    ...
    private void handlerCALLHELP(JSONObject jsonObject,ChannelHandlerContext ctx){
        ...
        //寻找家庭的其他用户
        Family family = innerFamilyService.getById(familyId);
        List<Long> familyUserIdsList = innerFamilyService.getFamilyUserIdsList(family);
