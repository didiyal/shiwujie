...
public interface CallHelpService extends IService<CallHelp> {
     ...
     * @return
     */
    CallHelpVO getCallHelpBlindChannel(HttpServletRequest request);
     ...
     * @return
     */
    CallHelpVO joinCallHelpBlindChannel(CallHelpJoinRequest callHelpJoinRequest, HttpServletRequest request);
     ...
     * @return
     */
    Boolean leaveCallHelpByBlind(HttpServletRequest request);
     ...
     * @return
     */
    Boolean leaveCallHelpByHelpUser(HttpServletRequest request);
