...
public class CommunityController {
    ...
    @Operation(summary = "通过ID查询社区信息vo")
    ...
    @Operation(summary = "分页查询社区下的子社区列表")
