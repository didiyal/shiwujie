...
> Web 后台技术债 / 缺陷登记。development 层（允许源码引用 `file:line`）。★ = 影响功能正确性。统计占位类缺口同步进 [ROADMAP.md](../../../docs/ROADMAP.md) 待实现「能力补全」。功能契约状态见 [product/current/functional-requirements.md](../../../docs/product/current/functional-requirements.md) FR-WEB。
