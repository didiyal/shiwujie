...
public class ProfileFragment extends Fragment {
    ...
    private void handleFamilyClick() {
        ...
        if (getActivity() != null) {
            try {
                ...
                // 替换式导航：家庭页替换“我的”，tabBar 切换不再停留在家庭页（2026-09-16 修复）
    ...
    private void showChangePhoneDialog() {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            apiService.updateVolunteerPhone("Bearer " + token, userId, newPhone).enqueue(
    ...
    private void showChangeUsernameDialog() {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            apiService.updateVolunteerInfo("Bearer " + token, buildUpdateNameRequest(userId, newName)).enqueue(
                    new ApiCallback<Boolean>(requireContext()) {
                @Override
                public void onSuccess(Boolean response) {
    ...
    private VolunteerVO buildUpdateNameRequest(Long userId, String newName) {
