...
public class AiFragment extends Fragment {
    ...
    private void showHelpDialog() {
        String message = "视无界是一款面向视障人士的无障碍助手，动口不动手。\n"
                + "一，语音对话：生活常识、健康问题直接问小界，小界联网搜索后语音回答。\n"
                + "二，打开软件和导航：说帮我打开微信，说我要去公园，小界帮您跳转软件、规划路线。\n"
                + "三，拍照识别：拍一张照片，小界告诉您眼前是什么，看不清可以继续追问；您也可以直接问小界，前方是什么，小界会帮您拍照识别。\n"
                + "四，紧急求助：一键视频呼叫家属。紧急求助需要先加入家庭：请让家属下载视无界，注册志愿者端账号并创建家庭，然后您对小界说帮我加入家庭，并告知家属手机号，小界会帮您加入。\n"
                + "五，志愿者求助：连线志愿者远程帮您看。\n"
                + "当前版本 " + com.swj.shiwujie.BuildConfig.VERSION_NAME + "。";
        if (ttsManager != null) {
