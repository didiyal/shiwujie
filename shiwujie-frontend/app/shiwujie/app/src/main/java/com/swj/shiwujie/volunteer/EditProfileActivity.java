...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void showChangePhoneDialog() {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            apiService.updateVolunteerPhone(
                    "Bearer " + token,
                    userId,
                    newPhone
            ).enqueue(new ApiCallback<Boolean>(this) {
    ...
    private void loadUserInfo() {
        ...
        apiService.getVolunteerVOById("Bearer " + token, userId).enqueue(new ApiCallback<VolunteerVO>(this) {
            @Override
            public void onSuccess(VolunteerVO data) {
                if (data != null) {
                    // 设置用户ID
                    tvUserId.setText("账号：" + data.getVolunteerId());
