...
> 本文件属 `development/v2.1.0/`（二期·已封版 2026-07-11）。**测试现状** + **验证点**（按模块，交叉引用 [product/v2.1.0/acceptance-criteria.md](../../product/v2.1.0/acceptance-criteria.md) 的 `AC-*`）+ **环境表** + **已知缺口**。版本指针 [../current.md](../current.md)。
...
> 用户可验收行为见 [product/v2.1.0/acceptance-criteria.md](../../product/v2.1.0/acceptance-criteria.md)（`AC-<MODULE>-<NN>`）。下表只列「验证这条 AC 用什么手段」。
